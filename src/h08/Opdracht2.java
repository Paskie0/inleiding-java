...
public class Opdracht2 extends Applet{
    ...
    int total = 0;
    Button m = new Button("Man (geen student)");
    Button v = new Button("Vrouw (geen student)");
    Button mStudent = new Button("Man (student)");
    Button vStudent = new Button("Vrouw (student)");
    ...
    public void paint(Graphics g) {
        g.drawString("Totaal mannen: " + mCounter, getWidth()/2-60, 90);
        g.drawString("Waarvan studenten: " + mStudentCounter, getWidth()/2-50, 105);
        g.drawString("Totaal vrouwen: " + vCounter, getWidth()/2-60, 125);
